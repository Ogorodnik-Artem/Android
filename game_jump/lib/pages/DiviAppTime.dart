...
class DiviAppTime extends StatefulWidget{
  const DiviAppTime({super.key});

  @override
  State<DiviAppTime> createState() => _DiviAppTimeState();
}

class _DiviAppTimeState extends State<DiviAppTime>{
