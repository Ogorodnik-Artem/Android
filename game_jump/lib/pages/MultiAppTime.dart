...
class MultiAppTime extends StatefulWidget{
  const MultiAppTime({super.key});

  @override
  State<MultiAppTime> createState() => _MultiAppTimeState();
}

class _MultiAppTimeState extends State<MultiAppTime>{
  ...
  void NewData(){
    ...
    o1 = Random().nextInt(10) + (porod - 5);

    o2 = Random().nextInt(8) + (porod - 4);

    o3 = Random().nextInt(5) + (porod - 2);
  }
            ...
            Row (
              ...
              children: [
                Column(
                    ...
                    children: [
                      if(answer == 1)
                        Text(' $porod ' , style: const TextStyle(
                          fontSize: 40,
                        ),)
                      else
